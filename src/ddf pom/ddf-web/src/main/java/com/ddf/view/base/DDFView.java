 ...
 */
public interface DDFView<U extends DDFViewListener> {
	...
	/**
	 * Return the current view map parameters, this means the set of parameters
	 * that have been passed to this view from the older view
	 * 
	 * @return the parameters map (name-value)
	 */
